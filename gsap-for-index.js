...
let circleAnimationParams3;
widthToDisplay < 640 ? (circleAnimationParams3 = {boxShadow: "0px 0px 100px 10px #d30000"}, circleAnimationParams2 = {boxShadow: "0px 0px 100px 10px #d30000,  inset 0px 0px 100px -20px #d30000", duration: 1, ease: "power3.inOut"}, circleAnimationParams1 = {boxShadow: "0px 0px 100px 10px #d30000"}) : (circleAnimationParams3 = {boxShadow: "0px 0px 150px 50px #d30000"}, circleAnimationParams2 = {boxShadow: "0px 0px 1000px 100px #d30000,  inset 0px 0px 100px -20px #d30000", duration: 1, ease: "power3.inOut"}, circleAnimationParams1 = {boxShadow: "0px 0px 1000px 100px #d30000"});
...
tl_to_scroll_7.to(".line-to-animate-gsap-4", {height: "calc(var(--size)*150px", duration: .4, delay: .01, ease: "power3.inOut"})
              ...
              .to(".road-circle-to-animate-gsap-3", {...circleAnimationParams3, backgroundSize: "100% 100%", duration: .7, ease: "power3.inOut"})
...
const circleAnimationParams4 = { duration: 3};

tl_to_scroll_9.to(".circle-to-animate-gsap-4", { x: -500, ...circleAnimationParams4 })
              .to(".circle-to-animate-gsap-7", { x: 500, ...circleAnimationParams4 }, 0)
              .to(".circle-to-animate-gsap-5", { x: -500, ...circleAnimationParams4 }, 1)
              .to(".circle-to-animate-gsap-8", { x: 500, ...circleAnimationParams4 }, 1)
              .to(".circle-to-animate-gsap-6", { x: -500, ...circleAnimationParams4 }, 2)
              .to(".circle-to-animate-gsap-9", { x: 500, ...circleAnimationParams4 }, 2);

tl_to_scroll_10.to(".circle-to-animate-gsap-4", { rotation: -60, ...circleAnimationParams4 })
               .to(".circle-to-animate-gsap-7", { rotation: 60, ...circleAnimationParams4 }, 0)
               .to(".circle-to-animate-gsap-5", { rotation: -60, ...circleAnimationParams4 }, 1)
               .to(".circle-to-animate-gsap-8", { rotation: 60, ...circleAnimationParams4 }, 1)
               .to(".circle-to-animate-gsap-6", { rotation: -60, ...circleAnimationParams4 }, 2)
               .to(".circle-to-animate-gsap-9", { rotation: 60, ...circleAnimationParams4 }, 2);
